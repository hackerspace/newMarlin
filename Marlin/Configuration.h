...
#define STRING_CONFIG_H_AUTHOR "(base48 Taz Config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "base48 TAZ"
...
#define USE_ZMAX_PLUG // due to probe
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5, 100.5, 400, 525}
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -100   // Z offset: -below +above  [the nozzle]
